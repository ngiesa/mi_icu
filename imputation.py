...
import numpy as np
import random
from methods import apply_interpolation, apply_averages, apply_mice_mf, apply_mice_lr_stats, apply_expanding, apply_averages, apply_locf, apply_mice_knn, apply_mice_temporal
    ...
    for dataset in DATASETS:
        ...
        for b, boot_df in enumerate(bootstrapps[dataset]["boots"]):
            ...
            for cv in range(0, 3):
                ...
                apply_mice_temporal(induced_df=df_induced).to_csv("./imputed_sequences/{}/mictemp_{}_{}_{}_cv_{}.csv".format(dataset.lower(), b, pattern, clean + direction, cv))
                print("stored")
                print("./imputed_sequences/{}/mictemp_{}_{}_{}_cv_{}.csv".format(dataset.lower(), b, pattern, clean + direction, cv))
