...
def induce_mcar(df: DataFrame = None, miss_prop: float = 0.1, time_colums: list = [], static_columns: list = [], store_path: str = ""):
    '''
    ...
    res = df[static_columns].merge(df_join, on=static_columns, how = "left")
    if store_path != "":
...
def induce_mar(df: DataFrame = None, cond_var: str = "age", time_colums:list = [], miss_range: list = [0.1, 0.9], 
                identifier: str = "case_id", static_columns: list = [], store_path: str = ""):
    '''
...
def induce_mnar(df: DataFrame = None, static_columns:list = [], time_colums:list = [], miss_range: list = [0.1, 0.9], store_path: str = ""):
    '''
